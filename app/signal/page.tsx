  ...
  return (
    <main className="min-h-screen bg-[#070B14]">
      ...
      <section className="pt-40 pb-16 px-6 md:px-10 max-w-4xl mx-auto">
        <p className="label text-[#D6B56E] mb-6">Signal</p>
        <h1
      ...
      <section className="px-6 md:px-10 pb-16 max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#EFE4CF]/20">
          {[
            ...
            <div key={item} className="bg-[#070B14] border border-[#EFE4CF]/30 p-6">
              <p
                className="text-[#EFE4CF]/65 text-sm leading-relaxed"
                style={{ fontFamily: "'Inter', system-ui, sans-serif" }}
              >
                {item}
              </p>
      ...
      <section className="px-6 md:px-10 pb-32">
        <div className="max-w-2xl mx-auto border border-[#EFE4CF]/30 bg-[#070B14]/80 p-8 md:p-10">
          <div className="flex items-center gap-4 mb-6">
            <Sigil variant="citrine" size={36} className="opacity-70" />
            <p className="label text-[#D6B56E]">Newsletter &amp; Updates</p>
          </div>
          <p
