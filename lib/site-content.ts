    ...
    sections: [
      {
        ...
        mode: "fact",
        body: [
          "There is no official municipal category called 'conduit signal.' The factual layer is simpler: weather changes, seasonal variations, route fatigue, mountain light, and the altered perception that can come with long rural travel are all real conditions.",
